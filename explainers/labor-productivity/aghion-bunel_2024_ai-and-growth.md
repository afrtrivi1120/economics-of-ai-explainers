...
- **Relevant magnitude for Colombia.** With Colombian potential growth around 3% and TFP growth typically <1 pp/year, a positive surprise of +0.68 pp/year in TFP — if the economy adopts AI at the pace of advanced economies — would be transformative. But Figure 4 (p. 7), based on Gmyrek et al. (2023) and the ILO, shows that AI exposure in middle-income countries is substantially lower than in the U.S. or the U.K.; Colombia appears explicitly with a smaller share of employment in high-exposure/high-complementarity categories. The conclusion: **the 1.3 pp/year ceiling applies to economies with advanced occupational structures; Colombia would likely capture a fraction of that.**
...
- **Competition policy.** Aghion and Bunel stress that concentration in upstream segments (data, compute) can neutralize productivity gains (pp. 13–14). For Colombia, this means AI policy is inseparable from digital competition policy: dependence on a few foreign compute and model providers limits the local capture of gains.
- **Education and reorganization.** Gains of 25–40% in cognitive tasks (customer service, coding, writing) point to productivity opportunities for Colombia's urban service sectors, but they require AI-use training and process redesign.
